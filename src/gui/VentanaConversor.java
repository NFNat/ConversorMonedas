...
public class VentanaConversor extends JFrame {
	...
	public VentanaConversor() {
		...
		setBounds(100, 100, 596, 458);
		panelPincipal = new JPanel();
		panelPincipal.setBackground(new Color(64, 128, 128));
		...
		lblTitulo.setFont(new Font("Baskerville Old Face", Font.BOLD, 33));
		...
		monedaInicial.setBackground(new Color(62, 121, 121));
		monedaInicial.setFont(new Font("Baskerville Old Face", Font.BOLD, 18));
		...
		lblMonedaFinal.setFont(new Font("Baskerville Old Face", Font.PLAIN, 24));
		lblMonedaFinal.setBounds(330, 167, 147, 33);
		panelPincipal.add(lblMonedaFinal);
		
		JComboBox monedaFinal = new JComboBox();
		monedaFinal.setBackground(new Color(62, 121, 121));
		monedaFinal.setFont(new Font("Baskerville Old Face", Font.BOLD, 18));
		...
		lblResultado.setFont(new Font("Baskerville Old Face", Font.BOLD, 21));
		lblResultado.setHorizontalAlignment(SwingConstants.CENTER);
		lblResultado.setBackground(new Color(64, 128, 128));
		...
		btnConvertir.setFont(new Font("Baskerville Old Face", Font.BOLD, 19));
		...
		txtCantidad.setFont(new Font("Baskerville Old Face", Font.BOLD, 17));
		txtCantidad.setBackground(new Color(64, 128, 128));
		txtCantidad.setBounds(300, 103, 147, 33);
		panelPincipal.add(txtCantidad);
		txtCantidad.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Cantidad");
		lblNewLabel_1.setFont(new Font("Baskerville Old Face", Font.PLAIN, 24));
		lblNewLabel_1.setBounds(148, 104, 128, 32);
